...
1. [Адаптивный AI-агент для определения профессии](#адаптивный-ai-агент-для-определения-профессии)  
   ...
   1.4. [Моделирование процессов и функций AI-ассистента](#моделирование-процессов-и-функций-ai-ассистента)  
       - [Акторы](#акторы)  
   ...
   1.5. [Проектирование базы данных](#проектирование-базы-данных)  
   ...
   1.6. [Работа с формой](#работа-с-формой)  
   1.7. [Описание методик](#описание-методик)  
   ...
   1.8. [Как построить адаптивный диалог](#как-построить-адаптивный-диалог)  
       ...
       - [Как реализовать обработку GPT: шаги](#как-реализовать-обработку-gpt-шаги)  
